...
#pragma region Windows Form Designer generated code
    ...
    void InitializeComponent(void) {
        ...
        this->dataGridViewSavingMoney = (gcnew System::Windows::Forms::DataGridView());
        ...
        this->dataGridViewRequests = (gcnew System::Windows::Forms::DataGridView());
        ...
        (cli::safe_cast<System::ComponentModel::ISupportInitialize ^>(this->dataGridViewSavingMoney))->BeginInit();
        this->panelContent->SuspendLayout();
        (cli::safe_cast<System::ComponentModel::ISupportInitialize ^>(this->dataGridViewRequests))->BeginInit();
        ...
        this->dataGridViewSavingMoney->AlternatingRowsDefaultCellStyle = dataGridViewCellStyle1;
        this->dataGridViewSavingMoney->AutoSizeColumnsMode = System::Windows::Forms::DataGridViewAutoSizeColumnsMode::Fill;
        this->dataGridViewSavingMoney->BackgroundColor = System::Drawing::SystemColors::ButtonFace;
        this->dataGridViewSavingMoney->CellBorderStyle = System::Windows::Forms::DataGridViewCellBorderStyle::SingleHorizontal;
        this->dataGridViewSavingMoney->ColumnHeadersBorderStyle = System::Windows::Forms::DataGridViewHeaderBorderStyle::None;
        ...
        this->dataGridViewSavingMoney->ColumnHeadersDefaultCellStyle = dataGridViewCellStyle2;
        this->dataGridViewSavingMoney->ColumnHeadersHeight = 60;
        this->dataGridViewSavingMoney->Columns->AddRange(gcnew cli::array<System::Windows::Forms::DataGridViewColumn ^>(8){this->Column1,
                                                                                                                           this->Column2, this->Column9, this->Column3, this->Column4, this->Column7, this->Column5, this->Column6});
        ...
        this->dataGridViewSavingMoney->DefaultCellStyle = dataGridViewCellStyle3;
        this->dataGridViewSavingMoney->Dock = System::Windows::Forms::DockStyle::Fill;
        this->dataGridViewSavingMoney->EnableHeadersVisualStyles = false;
        this->dataGridViewSavingMoney->GridColor = System::Drawing::SystemColors::ActiveCaptionText;
        this->dataGridViewSavingMoney->Location = System::Drawing::Point(0, 0);
        this->dataGridViewSavingMoney->Margin = System::Windows::Forms::Padding(4);
        this->dataGridViewSavingMoney->Name = L"dataGridViewSavingMoney";
        this->dataGridViewSavingMoney->ReadOnly = true;
        this->dataGridViewSavingMoney->RowHeadersBorderStyle = System::Windows::Forms::DataGridViewHeaderBorderStyle::Single;
        this->dataGridViewSavingMoney->RowHeadersVisible = false;
        this->dataGridViewSavingMoney->RowHeadersWidth = 51;
        this->dataGridViewSavingMoney->RowTemplate->DefaultCellStyle->BackColor = System::Drawing::Color::White;
        this->dataGridViewSavingMoney->RowTemplate->DefaultCellStyle->Font = (gcnew System::Drawing::Font(L"UTM Daxline", 12));
        this->dataGridViewSavingMoney->RowTemplate->DefaultCellStyle->ForeColor = System::Drawing::Color::Black;
        this->dataGridViewSavingMoney->RowTemplate->DefaultCellStyle->SelectionBackColor = System::Drawing::Color::Cyan;
        this->dataGridViewSavingMoney->RowTemplate->DefaultCellStyle->SelectionForeColor = System::Drawing::Color::Black;
        this->dataGridViewSavingMoney->RowTemplate->Height = 40;
        this->dataGridViewSavingMoney->RowTemplate->ReadOnly = true;
        this->dataGridViewSavingMoney->RowTemplate->Resizable = System::Windows::Forms::DataGridViewTriState::False;
        this->dataGridViewSavingMoney->SelectionMode = System::Windows::Forms::DataGridViewSelectionMode::FullRowSelect;
        ...
        dataGridViewCellStyle4->Font = (gcnew System::Drawing::Font(L"UTM Daxline", 12));
        ...
        this->dataGridViewRequests->AlternatingRowsDefaultCellStyle = dataGridViewCellStyle4;
        ...
        this->dataGridViewRequests->CellBorderStyle = System::Windows::Forms::DataGridViewCellBorderStyle::SingleHorizontal;
        this->dataGridViewRequests->ColumnHeadersBorderStyle = System::Windows::Forms::DataGridViewHeaderBorderStyle::None;
        dataGridViewCellStyle5->Alignment = System::Windows::Forms::DataGridViewContentAlignment::MiddleCenter;
        dataGridViewCellStyle5->BackColor = System::Drawing::Color::MediumOrchid;
        dataGridViewCellStyle5->Font = (gcnew System::Drawing::Font(L"UTM Daxline", 12, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
                                                                    static_cast<System::Byte>(0)));
        ...
        this->dataGridViewRequests->ColumnHeadersDefaultCellStyle = dataGridViewCellStyle5;
        this->dataGridViewRequests->ColumnHeadersHeight = 60;
        this->dataGridViewRequests->Columns->AddRange(gcnew cli::array<System::Windows::Forms::DataGridViewColumn ^>(6){this->dataGridViewTextBoxColumn1,
                                                                                                                        this->dataGridViewTextBoxColumn2, this->Column8, this->dataGridViewTextBoxColumn3, this->dataGridViewTextBoxColumn4, this->dataGridViewTextBoxColumn5});
        ...
        this->dataGridViewRequests->RowHeadersBorderStyle = System::Windows::Forms::DataGridViewHeaderBorderStyle::Single;
        this->dataGridViewRequests->RowHeadersVisible = false;
        this->dataGridViewRequests->RowHeadersWidth = 51;
        this->dataGridViewRequests->RowTemplate->DefaultCellStyle->BackColor = System::Drawing::Color::White;
        this->dataGridViewRequests->RowTemplate->DefaultCellStyle->Font = (gcnew System::Drawing::Font(L"UTM Daxline", 12));
        this->dataGridViewRequests->RowTemplate->DefaultCellStyle->ForeColor = System::Drawing::Color::Black;
        this->dataGridViewRequests->RowTemplate->DefaultCellStyle->SelectionBackColor = System::Drawing::Color::Cyan;
        this->dataGridViewRequests->RowTemplate->DefaultCellStyle->SelectionForeColor = System::Drawing::Color::Black;
        this->dataGridViewRequests->RowTemplate->Height = 40;
        this->dataGridViewRequests->RowTemplate->ReadOnly = true;
        this->dataGridViewRequests->RowTemplate->Resizable = System::Windows::Forms::DataGridViewTriState::False;
        ...
        // btnShowRequest
        //
        this->btnShowRequest->BackColor = System::Drawing::Color::Indigo;
        this->btnShowRequest->Cursor = System::Windows::Forms::Cursors::Hand;
        this->btnShowRequest->FlatAppearance->BorderSize = 0;
        this->btnShowRequest->FlatAppearance->MouseDownBackColor = System::Drawing::Color::Teal;
        this->btnShowRequest->FlatStyle = System::Windows::Forms::FlatStyle::Flat;
        this->btnShowRequest->Font = (gcnew System::Drawing::Font(L"UTM Daxline", 12, System::Drawing::FontStyle::Bold));
        this->btnShowRequest->ForeColor = System::Drawing::SystemColors::HighlightText;
        this->btnShowRequest->ImageAlign = System::Drawing::ContentAlignment::MiddleLeft;
        this->btnShowRequest->Location = System::Drawing::Point(340, 4);
        this->btnShowRequest->Margin = System::Windows::Forms::Padding(4);
        this->btnShowRequest->Name = L"btnShowRequest";
        this->btnShowRequest->Size = System::Drawing::Size(325, 50);
        ...
        // btnShowCustomer
        //
        this->btnShowCustomer->BackColor = System::Drawing::Color::Indigo;
        this->btnShowCustomer->Cursor = System::Windows::Forms::Cursors::Hand;
        this->btnShowCustomer->FlatAppearance->BorderSize = 0;
        this->btnShowCustomer->FlatAppearance->MouseDownBackColor = System::Drawing::Color::Teal;
        this->btnShowCustomer->FlatStyle = System::Windows::Forms::FlatStyle::Flat;
        this->btnShowCustomer->Font = (gcnew System::Drawing::Font(L"UTM Daxline", 12, System::Drawing::FontStyle::Bold));
        this->btnShowCustomer->ForeColor = System::Drawing::SystemColors::HighlightText;
        this->btnShowCustomer->ImageAlign = System::Drawing::ContentAlignment::MiddleLeft;
        ...
        this->btnShowCustomer->Size = System::Drawing::Size(332, 50);
        ...
        this->btnShowCustomer->Click += gcnew System::EventHandler(this, &AdminSavingMoneyForm::btnShowCustomer_Click);
        //
        // panel2
        //
        ...
        (cli::safe_cast<System::ComponentModel::ISupportInitialize ^>(this->dataGridViewSavingMoney))->EndInit();
        this->panelContent->ResumeLayout(false);
        (cli::safe_cast<System::ComponentModel::ISupportInitialize ^>(this->dataGridViewRequests))->EndInit();
